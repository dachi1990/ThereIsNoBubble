...
function TabReport() {
  ...
  const assetImplications = [
    ...
    {asset:"High-Yield Credit",weight:"Underweight",dir:"↓",color:t.red,rationale:"3.2% spreads near cycle tights; asymmetric risk skewed to the downside"},
